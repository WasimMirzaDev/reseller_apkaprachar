...
<div class="detail product-single-hover style--card " style="box-shadow: none !important;">
    <div class="overflow-hidden position-relative">
        <div class=" inline_product clickable d-flex justify-content-center ">
            ...
            <div class="quick-right-btn">
                ...
                <a href="#" class="quick-right-btn-a">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="" viewBox="0 0 16 16"><path fill="#000" fill-rule="evenodd" d="M5.905.28A8 8 0 0 1 14.5 3.335V1.75a.75.75 0 0 1 1.5 0V6h-4.25a.75.75 0 0 1 0-1.5h1.727a6.5 6.5 0 1 0 .526 5.994a.75.75 0 1 1 1.385.575A8 8 0 1 1 5.905.279Z" clip-rule="evenodd"/></svg>
                </a>
            </div>
            <div class="quick-view-btn">
                <a class="quick-view-btn-a" href="javascript:" data-product-id="{{ $product->id }}">ADD TO CART</a>
