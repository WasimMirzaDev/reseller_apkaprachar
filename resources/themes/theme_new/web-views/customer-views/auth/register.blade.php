        ...
        <div class="row">
            <div class="login-card col-6">
                <div class="mx-auto __max-w-760">
                    <h2 class="h4 mb-4 font-bold text-capitalize fs-18-mobile">{{ translate('sign_up')}}</h2>
                    <form class="needs-validation_" id="customer-register-form" action="{{ route('customer.auth.sign-up')}}"
                        ...
                        <div class="web-direction">
                            <div class="w-50 mt-4 __max-w-356">
                                <button class="w-50 btn btn--primary custom-register-btn" style="background-color: #000 !important;border-color: #000 !important;" id="sign-up" type="submit" disabled>
                                    {{ translate('sign_up') }}
                                </button>
                            </div>
            ...
            <div class="col-6">
                <div class="mx-auto ps-5" style="margin-top: 7rem;">
                    <h2 class="h3 mb-4 font-bold text-capitalize fs-18-mobile">{{ translate('Already Have An Account?')}}</h2>
                    <div class="mt-2" style="color: rgb(105 108 112 / var(--tw-text-opacity))">Welcome back. Sign in to access your personalized experience, saved preferences, and more. We{String.raw`'re`} thrilled to have you with us again!</div>
                    <a href="{{route('customer.auth.login')}}" class=" mt-4 btn btn--primary btn-block btn-shadow bg-dark custom-register-btn" type="submit" style="background-color: #000 !important;border-color: #000 !important;">Login</a>
                </div>
            </div>
        </div>
