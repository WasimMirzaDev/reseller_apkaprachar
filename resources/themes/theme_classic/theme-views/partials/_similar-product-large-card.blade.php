...
<div class="product d-flex flex-column gap-10 col-12 col-sm-6 col-md-4 col-lg-3 "
    onclick="location.href='{{route('product', $product->slug)}}'">
    <div class="product__top width--100 aspect-1  product-card-medium" style="height: 250px;">
        ...
        <div class="img w-100">
            <div class="medium-card-deal">
                <span>-40%</span>
            </div>
            <div class="view">
                <a href="javascript:"
                    class="btn-quickview stopPropagation get-quick-view text-center align-items-center"
                    data-product-id="{{$product['id']}}" data-action="{{route('quick-view')}}"
    ...
    <div class="product__summary d-flex flex-column pb-3 gap-2  cursor-pointer">

        <h6 class="product__title text-truncate d-flex">
        ...
        <div class="product__price d-flex flex-wrap column-gap-2">
            ...
            @endif
            <ins class="product__new-price text-danger">
