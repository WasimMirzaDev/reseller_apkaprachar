...
<div class="product d-flex flex-column gap-10 get-view-by-onclick" data-link="{{route('product', $product->slug)}}" style="background-color: #fff0;">
    <div class="product__top border product-card-medium">
        ...
        <!-- <div>
            <img src="{{ getValidImage(path: 'storage/app/public/product/thumbnail/'.$product['thumbnail'], type: 'product') }}"
                 loading="lazy" class="img-fit dark-support " alt="$product['name']">
        </div> -->
    ...
    <div class="product__summary d-flex flex-column gap-1 cursor-pointer">
        ...
        <div class="product__price d-flex flex-wrap column-gap-2 text-dan">
            @if($product->discount > 0)
