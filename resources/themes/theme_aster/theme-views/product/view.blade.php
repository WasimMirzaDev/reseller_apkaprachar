...
@section('title',$data['brand_name']. ' Clothing Online Shopping | Apka Fashion')

@push('css_or_js')
    <meta property="og:image" content="{{asset('storage/app/public/company')}}/{{$web_config['web_logo']}}"/>
    <meta property="og:title" content="{{$data['brand_name']}} Clothing Online Shopping | Apka Fashion"/>
    <meta property="og:url" content="{{env('APP_URL')}}">
       <meta name="description" content="Elevate your style with Apka Fashion's trendy and affordable {{$data['brand_name']}}. Explore a wide range of fashionable clothes and accessories that suit your individuality. Shop now!">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row gy-2 align-items-center">
                            <div class="col-lg-4">
                                <h1 class="mb-1" style="font-size: 20px;">Top {{$data['brand_name']}} Styles Online: Shop Now!</h1>
