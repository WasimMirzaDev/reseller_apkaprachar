                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <label class="title-color d-flex justify-content-between gap-2">
                                    ...
                                    <span class="style-one-pro cursor-pointer user-select-none text--primary action-onclick-generate-number {{ $product->is_imported == 1 ? 'd-none':'' }}" data-input="#generate_number">
                                        {{ translate('generate_code') }}
                                    </span>
                                </label>

                                <input type="text" id="generate_number" name="code" class="form-control" {{ $product->is_imported == 1 ? 'readonly':'' }}
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="quantity">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" value={{ $product->current_stock }} step="1"
                                       ...
                                       name="current_stock" id="current_stock" class="form-control" required {{ $product->is_imported == 1 ? 'readonly':'' }}>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
